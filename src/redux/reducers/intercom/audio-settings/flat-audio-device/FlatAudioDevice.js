...
const FlatAudioDeviceReducer = (state = initialState, action) => {
  switch(action.type) {
    ...
    case 'CHANGE_INTERCOM_FLAT_MICROPHONE_GAIN':
      return {
        ...state,
        microphone: {
          ...state.microphone,
    ...
    case 'CHANGE_INTERCOM_FLAT_MICROPHONE_AGC_MODE':
      return {
        ...state,
        microphone: {
          ...state.microphone,
    ...
    case 'CHANGE_INTERCOM_FLAT_MICROPHONE_AGC_MODE_MAX_GAIN':
      return {
        ...state,
        microphone: {
          ...state.microphone,
    ...
    case 'CHANGE_INTERCOM_FLAT_MICROPHONE_AGC_MODE_TARGET_LEVEL':
      return {
        ...state,
        microphone: {
          ...state.microphone,
    ...
    case 'CHANGE_INTERCOM_FLAT_SPEAKER_SFX_GAIN':
      return {
        ...state,
        speaker: {
          ...state.speaker,
    ...
    case 'CHANGE_INTERCOM_FLAT_SPEAKER_INTERCOM_GAIN':
      return {
        ...state,
        speaker: {
          ...state.speaker,
...
export default FlatAudioDeviceReducer
