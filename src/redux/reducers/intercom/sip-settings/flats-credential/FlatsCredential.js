...
const FlatsCredentialReducer = (state = initialState, action) => {
  switch(action.type) {
    case 'REQUEST_FLATS_CREDENTIAL_SUCCESS':
      return {
        ...state,
    ...
    case 'REQUEST_FLATS_CREDENTIAL_TURN_SUCCESS':
      return {
        ...state,
        turnServer: {
          server: action.payload.response.server,
    ...
    case 'CHANGE_FLATS_CREDENTIAL_SERVER':
      return {
        ...state,
        server: action.payload.server,
      }
    case 'CHANGE_FLATS_CREDENTIAL_LOGIN':
      return {
        ...state,
        login: action.payload.login,
      }
    case 'CHANGE_FLATS_CREDENTIAL_PASSWORD':
      return {
        ...state,
        password: action.payload.password,
      }
    case 'CHANGE_FLATS_CREDENTIAL_USE_STUN':
      return {
        ...state,
        useStun: !state.useStun,
      }
    case 'CHANGE_FLATS_CREDENTIAL_USE_STUN_MEDIA':
      return {
        ...state,
        useStunMedia: !state.useStunMedia,
      }
    case 'CHANGE_FLATS_CREDENTIAL_USE_ICE':
      return {
        ...state,
        useIce: !state.useIce,
      }
    case 'CHANGE_FLATS_CREDENTIAL_USE_TURN':
      return {
        ...state,
        useTurn: !state.useTurn,
      }
    case 'CHANGE_FLATS_CREDENTIAL_TURN_SERVER_SERVER':
      return {
        ...state,
        turnServer: {
          ...state.turnServer,
    ...
    case 'CHANGE_FLATS_CREDENTIAL_TURN_SERVER_CONNECTION_TYPE':
      return {
        ...state,
        turnServer: {
          ...state.turnServer,
    ...
    case 'CHANGE_FLATS_CREDENTIAL_TURN_SERVER_LOGIN':
      return {
        ...state,
        turnServer: {
          ...state.turnServer,
    ...
    case 'CHANGE_FLATS_CREDENTIAL_TURN_SERVER_PASSWORD':
      return {
        ...state,
        turnServer: {
          ...state.turnServer,
...
export default FlatsCredentialReducer
